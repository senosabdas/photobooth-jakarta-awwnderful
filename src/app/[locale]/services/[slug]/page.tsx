...
import { trackBookingInterest, trackServiceView } from '@/lib/analytics'
...
const services: Record<string, Service> = {
    ...
    backdrops: [
      {
        ...
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-caramel-sequin-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Peacock Sequin Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-peacock-sequin-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Pink Sequin Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-pink-sequin-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Black Sequin Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-black-sequin-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Shiny Silver Sequin Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-silver-sequin-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Pink Solid Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-solid-pink-large-jakarta.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'White Solid Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-white-solid-large.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Green Solid Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-green-solid-large.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Yellow Solid Large',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-yellow-solid-large.webp',
        description: '1.8m x 1.8m fixed size backdrop'
      },
      {
        title: 'Black & Gold Sequin Small',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-black-gold-sequin-small-jakarta.webp',
        description: 'up to 1.5m x 1.5m Adjustable backdrop '
      },
      {
        title: 'White Sequin Small',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-white-sequin-small-jakarta.webp',
        description: 'up to 1.5m x 1.5m Adjustable backdrop '
      },
      {
        title: 'Black Solid Small',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-black-solid-small-jakarta.webp',
        description: 'up to 1.5m x 1.5m Adjustable backdrop '
      },
      {
        title: 'Greenscreen Backdrop',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-greenscreen-backdrop.webp',
        description: 'Greenscreen effect with choice of your own design'
      },
      {
        title: 'Custom Hard Panel',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-custom-hard-panelling.webp',
        description: 'Strong panel with carpet and lighting'
      },
      {
        title: 'Custom 3D  Pop up backdrop',
        image: '/images/services/backdrop-photo-booth-jakarta/backdrop-photo-booth-jakarta-custom-3d-pop-up.webp',
        description: 'Custom Pop up Backdrop with your choice of design'
      },
      {
        title: 'Custom Decoration',
        image: '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-engagement-decoration-1.webp',
        description: 'Custom Backdrop with Flower of your choice'
      }
    ],
    gallery: [
      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-1.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-2.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-3.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-gif-jakarta-dslr-print-out-1.webp',

      '/images/services/photo-booth-gif-jakarta/photo-booth-gif-jakarta-dslr-print-out-3.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-gif-jakarta-dslr-print-out-4.webp',

      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-4.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-5.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-o-setup-jakarta-6.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-1.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-2.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-3.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-4.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-5.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-6.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-7.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-8.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-9.webp',
      '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-10.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-1.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-2.webp',
      '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-3.webp'
     
    ],
    models: [
      {
        title: 'DSLR Booth',
        image: '/images/services/photo-booth-gif-jakarta/photo-booth-gif-jakarta-photobooth-dslrbooth-icon.png',
        description: '-',
      ...
      gallery: [
        '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-5.webp',
        '/images/services/photo-booth-gif-jakarta/sewa-photo-booth-dslr-setup-jakarta-8.webp',
        '/images/services/photo-booth-gif-jakarta/photo-booth-dslr-setup-jakarta-4.webp',
        
      ]
      },
      {
        title: 'Classic Booth',
        image: '/images/services/photo-booth-gif-jakarta/photo-booth-classic-jakarta-icon.png',
        ...
        gallery: [
          ...
          '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-2.webp',
          '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-3.webp',
          '/images/services/photo-booth-gif-jakarta/photo-booth-classic-setup-jakarta-4.webp',

        ]
      },
      {
        title: 'O Booth',
        image: '/images/services/photo-booth-gif-jakarta/photo-booth-o-jakarta-icon.png',
        description: '-',
  ...
  'roaming-photo-booth': {
    ...
    `,
    image: '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-printout-result.webp',
    features: [
      'High-quality camera',
      'Professional lighting',
      'Optional Backdrops',
    ...
    gallery: [
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-roaming-multicamera-1.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-roaming-multicamera-2.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-roaming-multicamera-3.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-roaming-multicamera-4.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-ring-roamer-1.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-ring-roamer-2.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-ring-roamer-3.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-ring-roamer-4.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-dslr-roamer-1.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-dslr-roamer-2.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-dslr-roamer-3.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-photo-roamer-sharing-kiosk-printer-1.webp',
      '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-photo-roamer-sharing-kiosk-printer-2.webp'
    ],
    models: [
      {
        title: 'DSLR Roamer',
 ...
 
      {
        ...
        image: '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-multiroam.webp',
      ...
      {
        title: 'Ring Roamer',
        image: '/images/services/roaming-photo-booth-jakarta/roaming-photo-booth-jakarta-ringroamer.webp',
  ...
  '360-video-booth': {
    ...
    gallery: [
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-1.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-2.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-3.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-4.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-5.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-6.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-7.webp',
      '/images/services/photo-booth-360-video-jakarta/photo-booth-360-video-jakarta-8.webp'
    ],
  ...
  'hashtag-printer': {
    ...
    gallery: [
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-1.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-2.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-3.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-4.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-5.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-6.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-7.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-8.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-9.webp',
      '/images/services/hashtag-printer-jakarta/hashtag-printer-jakarta-gallery-10.webp'
    ],
  ...
  'virtual-photo-booth': {
    ...
    fullDescription: `
      ...
      • Download and share
    `,
    image: '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-virtual-photo-booth-hero.mp4',
    features: [
      'Unlimited photos',
      'Web-based access',
    ...
    gallery: [
      '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-virtualbooth-setup-1.png',
      '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-virtualbooth-setup-3.png',
      '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-virtual-booth.mp4',
      '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-virtualbooth-setup-2.png'
    ],
    models: [
      {
        title: 'Guest Cam',
        image: '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-guest-cam.webp',
      ...
      },
      {
        ...
        image: '/images/services/virtual-photo-booth-jakarta/virtual-photo-booth-jakarta-web-based-photobooth.png',
...
• On site staff
    `,
    image: '/images/services/video-booth-jakarta/video-booth-jakarta-videobooth-setup-1.webp',
    features: [
      'HD video recording',
      'Professional audio',
      'Custom effects',
    ...
    gallery: [
      '/images/services/video-booth-jakarta/video-booth-jakarta-gallery-1.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-gallery-2.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-gallery-3.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-videobooth-setup-1.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-videobooth-setup-3.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-videobooth-setup-4.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-virtualrunway-1.webp',
      '/images/services/video-booth-jakarta/video-booth-jakarta-animatedobject-1.png'
    ...
    models: [
      {
        title: 'Glam Booth',
        image: '/images/services/video-booth-jakarta/Gallery-2.webp',
      ...
      },
      {
        ...
        image: '/images/services/video-booth-jakarta/video-booth-jakarta-virtualrunway-2.png',
      ...
      },
      {
        ...
        image: '/images/services/video-booth-jakarta/video-booth-jakarta-animatedobject-1.png',
  ...
  'livestreaming': {
    ...
    `,
    image: '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-3.webp',
    features: [
    ...
    gallery: [
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-1.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-2.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-3.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-4.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-5.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-6.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-7.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-8.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-9.webp',
      '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-10.webp',
      '/images/services/livestreaming-photo-booth-jakarta/awwnderful-livestreaming-setup-11.webp'
    ],
    models: [
      {
        title: 'Livestream Pro',
        image: '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-4.webp',
      ...
      },
      {
        ...
        image: '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-awwnderful-livestreaming-setup-7.webp',
      ...
      },
      {
        ...
        image: '/images/services/livestreaming-photo-booth-jakarta/livestreaming-photo-booth-jakarta-service-livecam.webp',
    ...
    outputSamples: [
      {
        ...
        image: "/images/lookbook-photo-booth-jakarta/multicamera-photo-greenscreen-5.mp4",
        type: "video"
      },
      {
        title: "Synchronized Boomerang",
        image: "/images/lookbook-photo-booth-jakarta/multicamera-boomerang-greenscreen-1.mp4",
        type: "video"
      },
      {
        title: "Dynamic Photo Sequence",
        image: "/images/lookbook-photo-booth-jakarta/multicamera-photo-greenscreen-2.mp4",
        type: "video"
      }
    ],
    gallery: [
      '/images/services/multicamera-photo-booth-jakarta-hero.jpg ',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-2.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-3.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-4.webp', 
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-5.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-6.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-7.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-8.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-9.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-10.webp',
      '/images/services/multicamera-photo-booth-jakarta/multicamera-photo-booth-jakarta-awwnderful-multicamera-setup-11.webp'
    ],
    slug: 'multicamera'
  },
  'ai-photo-booth': {
...
• On site staff
    `,
    image: '/images/services/ai-photo-booth-jakarta/ai-photo-booth-jakarta-ai-mini-figure-toy.png',
    features: [ 
      'AI effects',
    ...
    outputSamples: [
      ...
      },
      {
        ...
        image: "/images/lookbook-photo-booth-jakarta/fxbooth-photo-ai-2.webp",
        type: "image"
      },
      {
        title: "Cake effect",
        image: "/images/services/ai-photo-booth-jakarta/ai-photo-booth-jakarta-ai-cake.mp4",
        type: "video"
      },
      {
        title: "Drawing Style",
        image: "/images/services/ai-photo-booth-jakarta/ai-photo-booth-jakarta-ai-drawing-1-result.png",
        type: "image"
      },
      {
        title: "Breathe fire",
        image: "/images/services/ai-photo-booth-jakarta/ai-photo-booth-jakarta_breathe fire_2.mp4",
        type: "video"
      },
      {
        title: "Zombie effect",
        image: "/images/services/ai-photo-booth-jakarta/ai-photo-booth-jakarta_zombie effect_1.mp4",
        type: "video"
      },
  
    ],
    gallery: [
        '/images/services/ai-photo-booth-jakarta/ai-photo-booth-gallery-jakarta-2.webp',
    ...
    models: [
      {
        ...
        image: '/images/services/custom-photo-print-jakarta/hologram-photobooth-sample-jakarta-1.webp',
        ...
        gallery: [
          '/images/services/custom-photo-print-jakarta/hologram-photobooth-sample-jakarta-1.webp',
          '/images/services/custom-photo-print-jakarta/hologram-photobooth-sample-jakarta-3.webp',
          '/images/services/custom-photo-print-jakarta/custom-photo-print-jakarta-hologram-reels.mp4'
        ],
        links: [
      ...
      {
        title: 'Sticker Print',
        image: '/images/services/custom-photo-print-jakarta/sticker-photobooth-jakarta.webp',
        description: '',
      ...
      {
        title: 'Acrylic Frame',
        image: '/images/services/custom-photo-print-jakarta/frame-acrylic-photobooth-jakarta.webp',
        description: '-',
      ...
      {
        title: 'Wooden Frame',
        image: '/images/services/custom-photo-print-jakarta/wooden-frame-photobooth-jakarta.webp',
        description: '',
      ...
      },
      {
        ...
        image: '/images/services/custom-photo-print-jakarta/custom-photo-print-jakarta-custom-paper-frame.png',
      ...
      {
        title: 'Cookie Photo',
        image: '/images/services/custom-photo-print-jakarta/cookies-photobooth-jakarta.webp',
        description: 'Compact holographic prints perfect for gifts',
      ...
      },
      {
        ...
        image: '/images/services/custom-photo-print-jakarta/magnetic-print-photobooth-jakarta.webp',
        description: 'Compact holographic prints perfect for gifts',
      ...
      {
        title: 'Guest Book',
        image: '/images/services/custom-photo-print-jakarta/guestbook-photobooth-jakarta.webp',
        description: 'Compact holographic prints perfect for gifts',
  ...
  'decoration': {
    ...
    `,
    image: '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-1.webp',
    features: [
    ...
    gallery: [
      '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-1.webp',
      '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-2.webp',
      '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-3.webp',
      '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-4.webp',
      '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-5.webp',
       '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-wedding-decoration-6.webp'
    ],
    models: [
      {
      ...
      },
      {
        ...
        image: '/images/services/wedding-decoration-jakarta/wedding-decoration-jakarta-birthday-decoration-1.webp',
  ...
  'photo-video-documentation': {
    ...
    `,
    image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photographer-1.webp',
    features: [
    ...
    gallery: [
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-dly07905.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-dly07907.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-dly07993.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-1.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-2.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-3.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-4.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-5.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-6.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-7.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-8.webp',
      '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-photo-documentation-9.webp',
      '/images/services/photo-video-documentation-jakarta/photo-documentation-10.webp'
    ],
    models: [
      {
        title: 'Drone Photography & Videography',
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-service-drone.avif',
      ...
      },
      {
        ...
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-service-cinematic-video.avif',
      ...
      },
      {
        ...
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-dly07993.webp',
      ...
      },
      {
        ...
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-service-wedding-content-creator.webp',
        description: 'Complete photo and video coverage of your event.',
      ...
      },
      {
        ...
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-service-prewedding.webp',
      ...
      },
      {
        ...
        image: '/images/services/photo-video-documentation-jakarta/photo-video-documentation-jakarta-service-360.webp',
  ...
  'light-painting': {
    ...
    `,
    image: '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photobooth-setup-jakarta-2.mp4',
    features: [
    ...
    gallery: [
      '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photo-booth-jakarta-lightpainting-result-1.webp',
      '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photo-booth-jakarta-lightpainting-result-2.webp',
      '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photo-booth-jakarta-lightpainting-result-3.webp',
      '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photobooth-setup-jakarta-1.webp'
    ],
    models: [
      {
        title: 'Multicamera LightPainting',
        image: '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photobooth-setup-jakarta-3.webp',
      ...
      },
      {
        ...
        image: '/images/services/lightpainting-photo-booth-jakarta/lightpainting-photo-booth-jakarta-lightpainting-result-1.webp',
  ...
  'audio-rental': {
    ...
    `,
    image: '/images/services/sewa-audio-rental-jakarta/sewa-audio-rental-setup-jakarta-1.webp',
    features: [
      'Professional equipment',
    ...
    models: [
      {
        title: '1000W Package',
        image: '/images/services/sewa-audio-rental-jakarta/paket-audio-rental-1000w-jakarta.webp',
      ...
      {
        title: '1500W Package',
        image: '/images/services/sewa-audio-rental-jakarta/paket-audio-rental-1500w-jakarta.webp',
      ...
      {
        title: '2000W Package',
        image: '/images/services/sewa-audio-rental-jakarta/paket-audio-rental-2000w-jakarta.webp',
      ...
      {
        title: '2500W Package',
        image: '/images/services/sewa-audio-rental-jakarta/paket-audio-rental-2500w-jakarta.webp',
        description: 'Professional-grade sound for large venues',
        details: 'Our 2000W package provides powerful, professional-grade sound with exceptional clarity and coverage.',
        features: [
          '2000W Power Output',
      ...
      {
        title: '4000W Package',
        image: '/images/services/sewa-audio-rental-jakarta/paket-audio-rental-4000w-jakarta.webp',
        description: 'Professional-grade sound for large venues',
        details: 'Our 2000W package provides powerful, professional-grade sound with exceptional clarity and coverage.',
        features: [
          '2000W Power Output',
      ...
      },
      {
        ...
        image: '/images/services/sewa-audio-rental-jakarta/sewa-audio-rental-jakarta-findoutmore.webp',
        description: 'Professional-grade sound for large venues',
        details: 'Our 2000W package provides powerful, professional-grade sound with exceptional clarity and coverage.',
        features: [
          '2000W Power Output',
    ...
    gallery: [
      '/images/services/sewa-audio-rental-jakarta/sewa-audio-rental-setup-jakarta-1.webp',
      '/images/services/sewa-audio-rental-jakarta/sewa-audio-rental-setup-jakarta-2.webp',
      '/images/services/sewa-audio-rental-jakarta/sewaaudio-setup-4.mp4',
      '/images/services/sewa-audio-rental-jakarta/sewaaudio-setup-5.mp4',
      '/images/services/sewa-audio-rental-jakarta/sewaaudio-setup-6.webp'
    ],
    slug: 'audio-rental'
  },
  'interactive-display': {
    ...
    gallery: [
      '/images/services/interactive-display-jakarta/interactive-display-jakarta-digital-wishes-1.webp',
      '/images/services/interactive-display-jakarta/interactive-display-jakarta-photo-slideshow-1.webp',
      '/images/services/interactive-display-jakarta/interactive-display-jakarta-photo-slideshow-3.mp4',
      '/images/services/interactive-display-jakarta/interactive-display-jakarta-photo-slideshow-4.mp4',
      '/images/services/interactive-display-jakarta/interactive-display-jakarta-photo-slideshow-5.webp'
    ],
    models: [ // Models for interactive-display
      {
        title: 'Photobooth Slideshow',
        image: '/images/services/interactive-display-jakarta/interactive-display-jakarta-slideshow-1.webp',
      ...
      },
      {
        ...
        image: '/images/services/interactive-display-jakarta/interactive-display-jakarta-digital-wishes-1.webp',
      ...
      {
        title: 'Mosaic Photos',
        image: '/images/services/interactive-display-jakarta/interactive-display-jakarta-digital-wishes-1.webp', // Placeholder, assuming similar image
  ...
  'invitation-digitalguestbook': { // This is the first, corrected definition
    ...
    `,
    image: '/images/services/invitation-digital-guestbook-jakarta/digitalguestbook-photobooth-jakarta-setup-1.webp',
    features: [
      'Manajemen meja tamu',
    ...
    gallery: [
      '/images/services/invitation-digital-guestbook-jakarta/digitalguestbook-photobooth-jakarta-web-1.mp4',
      '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-websiteinvitation-setup-1.webp',
      '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-video-invitation-2.mp4',
      '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-usher-1.webp',
      '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-usher-2.webp'
    ],

    models: [ // Models from the second definition are now here
      {
        title: 'Website Invitation',
        image: '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-websiteinvitation-setup-1.webp',
      ...
      },
      {
        ...
        image: '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-video-invitation-1.png',
      ...
      },
      {
        ...
        image: '/images/services/invitation-digital-guestbook-jakarta/invitation-digital-guestbook-jakarta-usher.webp',
        description: '-',
  ...
  'virtual-reality': {
    ...
    `,
    image: '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-vr-hero.png',
    features: [
      'Premium VR headsets',
    ...
    gallery: [
      '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-soccer-games-vr.webp',
      '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-driving-simulation-vr.webp',
    ],
    models: [
      {
        title: 'AR Filter & Social media filter',
        image: '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-instagram-filter.png',
      ...
      },
      {
        ...
        image: '/images/services/virtual-reality-photo-booth-jakarta/vr-game-jakarta.webp',
      ...
      {
        title: 'VR Tour',
        image: '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-vr-tour.png',
      ...
      {
        title: 'VR Education',
        image: '/images/services/virtual-reality-photo-booth-jakarta/virtual-reality-photo-booth-jakarta-vr-education.avif',
      ...
      },
      {
        ...
        image: '/images/services/virtual-reality-photo-booth-jakarta/vr-car-simulation-jakarta.webp',
      ...
      },
      {
        ...
        image: '/images/services/virtual-reality-photo-booth-jakarta/corporate-vr-training-jakarta.webp',
  ...
  'photobox': {
    ...
    `,
    image: '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-1.webp',
    features: [
      'Custom model based on your event theme',
      'BoothBox model'
    ],
    gallery: [
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-1.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-2.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-3.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-4.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-5.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-6.webp',
      '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-custom-photobox-setup-1.webp',
    ...
    models: [
      {
        title: 'The Boothbox',
        image: '/images/services/boothbox-photo-booth-jakarta/boothbox-photo-booth-jakarta-photobox-setup-3.webp',
      ...
      },
      {
        ...
        image: '/images/services/photobox-jakarta/photobox-jakarta-high-angle.webp',
        ...
        gallery: [
          '/images/services/photobox-jakarta/photobox-jakarta-high-angle.webp',
...
function RelatedBlogs({ service }: { service: Service }) {
  ...
  return (
    <div className="mt-16 w-full overflow-hidden">
      <h2 className="text-2xl font-bold text-white mb-8">{t.servicePage.relatedBlogsCaseStudies}</h2>
...
function ServicePageContent() {
  ...
  const [stickyStyles, setStickyStyles] = useState<{width: number, left?: number, right?: number}>({width: 0, right: 0});
  const t = getTranslation(language);
  const serviceTranslation = getServiceTranslation(language, slug as string);
  ...
  // Simplified and reliable sticky behavior
  useEffect(() => {
    const handleScroll = () => {
      if (!featuresRef.current || !blogSectionRef.current) return;
      ...
      // Get content container boundaries (yellow area)
      const contentContainer = aboutSectionRef.current?.parentElement;
      ...
      // Only operate within the content container boundaries
      const withinContentBounds = scrollTop >= containerTop - navHeight && 
                                 scrollTop <= containerBottom - navHeight - featuresRect.height;
      
      // Start sticking when features section would hit navigation within content area
      const featuresOriginalTop = featuresRef.current.offsetTop;
      const shouldStartSticking = scrollTop >= featuresOriginalTop - navHeight && withinContentBounds;
      
      // Stop sticking when blog section approaches OR when leaving content bounds
      const shouldStopSticking = blogRect.top <= navHeight + featuresRect.height + 100 || !withinContentBounds;
      
      const isNowSticky = shouldStartSticking && !shouldStopSticking;
      
      if (isNowSticky !== isSticky) {
        if (isNowSticky && aboutSectionRef.current) {
          // Get the main content container for proper positioning
          const contentContainer = aboutSectionRef.current.parentElement; // The lg:flex lg:gap-12 container
          if (contentContainer) {
            const containerRect = contentContainer.getBoundingClientRect();
            const featuresRect = featuresRef.current.getBoundingClientRect();
            
            // Calculate position to stay within the content area
            const rightColumnWidth = containerRect.width * 0.33; // Features take 1/3 of container
            const leftPosition = containerRect.left + (containerRect.width * 0.67) + 16; // Start after left column + gap
            
            setStickyStyles({
              width: Math.min(featuresRect.width, rightColumnWidth - 32), // Account for padding
              left: leftPosition
            });
          }
        }
  ...
  if (!service) {
    ...
    <main className="pt-24 pb-32 relative overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href={`/${locale}/#services`}
          className="inline-flex items-center gap-2 text-white hover:text-blue-400 mb-8"
        >
          <ArrowLeft className="w-4 h-4" />
          {t.servicePage.viewAllServices}
        </Link>
        ...
        <div className="relative aspect-[4/3] sm:aspect-[3/2] lg:aspect-[2/1] rounded-xl overflow-hidden mb-12">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 lg:p-8 text-white">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 sm:mb-4">{serviceTranslation?.title || service.title}</h1>
            <p className="text-sm sm:text-lg lg:text-xl text-white/90 line-clamp-3">{serviceTranslation?.description || service.description}</p>
          </div>
        </div>
        ...
        <div className="lg:flex lg:gap-12 mb-16">
          {/* About Section */}
          <div ref={aboutSectionRef} className="lg:flex-1 lg:w-2/3 mb-8 lg:mb-0" id="about-service">
            <h2 className="text-2xl font-bold text-white mb-6">{t.servicePage.aboutService}</h2>
            <div className="prose prose-lg max-w-none prose-p:text-gray-300">
              {(serviceTranslation?.fullDescription || service.fullDescription).split('\n').map((paragraph, index) => (
          ...
          {/* Features Section - Now separate from about section */}
          <div className="lg:w-1/3">
            <div 
              ref={featuresRef}
              className={`bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 z-40 transition-all duration-300 ${
                isSticky 
                  ? 'fixed top-24 shadow-2xl shadow-purple-500/20 bg-gray-800/80 border border-purple-400/30' 
                  : 'relative shadow-lg'
              }`}
              id="service-features"
              style={{
            ...
            >
              <h3 className="text-xl sm:text-2xl font-bold text-white mb-6">{t.servicePage.features}</h3>
              <ul className="space-y-4 mb-8">
                {(serviceTranslation?.features || service.features).map((feature, index) => (
              ...
              <Link
                ...
                onClick={() => trackBookingInterest(`service-sidebar-${slug}`)}
              >
                {t.nav.bookNow}
              </Link>
            </div>
        ...
        {/* Related Blog Section - Now separate */}
        <div ref={blogSectionRef} className="mb-16">
        ...
        {(slug === 'photobooth-gif' || slug === 'ai-photo-booth' || 
          ...
          <div ref={modelsSectionRef} className="mb-16 relative" id="service-options">
            <h2 className="text-2xl font-bold text-white mb-6">{t.servicePage.chooseYourService}</h2>
        ...
        {service.outputSamples && service.outputSamples.length > 0 && (
          <div className="mt-16 mb-16" id="output-samples">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl font-bold text-white">{t.servicePage.outputSamples}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {slug === 'photobooth-gif' && service.backdrops && (
          <div className="mb-16" id="backdrop-selection">
            <h2 className="text-2xl font-bold text-white mb-6">Choose Your Backdrop</h2>
                ...
                {service.backdrops.map((backdrop, index) => (
                  <div
                    ...
                    onClick={() => {
                      ...
                      const modalContainer = document.getElementById('backdrop-modal-container')
                      if (modal && modalContainer) {
                        ...
                        img.alt = 'Backdrop Preview'
                        img.className = 'rounded-lg max-w-full max-h-full object-contain'
            ...
            >
              ...
              <div className="relative w-full max-w-4xl mx-4" id="backdrop-modal-container">
                {/* Image will be dynamically inserted via JavaScript */}
              </div>
            </div>
          </div>
        )}
        ...
        {service.gallery && service.gallery.length > 0 && (
          <div className="mb-16" id="gallery">
            <h2 className="text-2xl font-bold text-white mb-6">{t.servicePage.gallery}</h2>
            <Gallery images={service.gallery} />
          </div>
        )}

        {/* Bottom CTA */}
        <div className="text-center" id="booking-cta">
          <h3 className="text-4xl font-bold text-white mb-4">{t.nav.bookNow}</h3>
          ...
          <Link
            ...
            onClick={() => trackBookingInterest(`service-${slug}`)}
          >
            Book Now
